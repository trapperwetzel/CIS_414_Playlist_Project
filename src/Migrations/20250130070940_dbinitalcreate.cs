...
{
    /// <inheritdoc />
    public partial class dbinitalcreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongGenres", x => new { x.GenresGenreId, x.SongsSongId });
                    table.ForeignKey(
                        name: "FK_SongGenres_Genres_GenresGenreId",
                        column: x => x.GenresGenreId,
                        principalTable: "Genres",
                        principalColumn: "GenreId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongGenres_Songs_SongsSongId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongMoods", x => new { x.MoodsMoodId, x.SongsSongId });
                    table.ForeignKey(
                        name: "FK_SongMoods_Moods_MoodsMoodId",
                        column: x => x.MoodsMoodId,
                        principalTable: "Moods",
                        principalColumn: "MoodId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongMoods_Songs_SongsSongId",
                        column: x => x.SongsSongId,
                        principalTable: "Songs",
                        principalColumn: "SongId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongGenres_SongsSongId",
                table: "SongGenres",
                column: "SongsSongId");

            migrationBuilder.CreateIndex(
                name: "IX_SongMoods_SongsSongId",
                table: "SongMoods",
                column: "SongsSongId");
